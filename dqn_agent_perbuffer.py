...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        # use 1.0 as initial priority error
        error = 1.0
    ...
    def learn(self, experiences, gamma):
        ...
        Params
        ======
            experiences (Tuple[torch.Tensor]): tuple of (s, a, r, s', done, priority) tuples 
        ...
        # normalize weights by 1/ max wi so that they only scale the update downwards
        w_j = w_i/max(w_i)
...
class PEReplayBuffer:
    ...
    def sample(self):
        ...
        # select randomly
        #idx = random.sample(range(self.memory.__len__()), k=self.batch_size)
